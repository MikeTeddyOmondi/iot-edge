...
# wget https://github.com/cloudflare/workerd/releases/download/v1.20231030.0/workerd-linux-64.gz
# gunzip workerd-linux-64.gz
# mv workerd-linux-64 workerd
# chmod +x workerd

# wget https://github.com/cloudflare/workerd/releases/latest/download/workerd-linux-64.gz
# gunzip workerd-linux-64.gz
# mv workerd-linux-64 workerd
# chmod +x workerd
